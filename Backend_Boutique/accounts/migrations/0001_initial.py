    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('address', models.TextField(blank=True, null=True, verbose_name='Domicilio')),
                ('user_type', models.CharField(choices=[('admin', 'Administrador'), ('seller', 'Vendedor'), ('customer', 'Cliente'), ('supplier', 'Proveedor')], default='customer', max_length=20, verbose_name='Tipo de Usuario')),
